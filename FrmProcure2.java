...
public class FrmProcure2 extends JFrame {
    ...
    public FrmProcure2() {
        ...
        JComboBox comboBoxGHS = new JComboBox();
        ...
        btnSure.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //供货商名称
                String ghname = comboBoxGHS.getSelectedItem().toString();
                //应付总金额
                ...
                WareHouse wareHouse = new WareHouse(nu, java.sql.Date.valueOf(date),
                        ghname, totalmoney2, smoney2, people);
                //新增采购详情
...
//					}				
        ...
        txtYMoney.setForeground(new Color(255, 102, 102));
...
//		tabbedPane.addTab("单据审核", null, panel_1, null);
     ...
     * @param price
     */
    public void addRow(String ssid, String sname, String sunit, String ysmoney, String caigouprice, String count, String price) {
        //"商品编号", "商品名称", "单位","预设进价", "当前进价", "数量", "总金额"
        Object[] row = {
                ssid, sname, sunit, ysmoney, caigouprice, count, price
        };
    ...
    public void addRow2(Repertory repertory, String count, String price) {
        ...
        Object[] row2 = {
                ...
                price,
                count,
                new BigDecimal(count).multiply(new BigDecimal(price))
        };
...
//		}
    ...
    public void cc() {
        ...
        tableGhs = new JTable();
        tableGhs.setModel(new DefaultTableModel(
                new Object[][]{
        ...
        {
            //设置行高
            tableGhs.setRowHeight(30);
            //设置表头对象
            JTableHeader hh = tableGhs.getTableHeader();
            hh.setBorder(BorderFactory.createLineBorder(new Color(120, 192, 110)));// 边框
            hh.setBackground(new Color(120, 192, 110));// 背景颜色
            ...
            hh.setPreferredSize(new Dimension(hh.getWidth(), (40)));//40 指的是表头的高度
            tableGhs.setTableHeader(hh);
            //设置表格内容居中
            DefaultTableCellRenderer render = new DefaultTableCellRenderer();
            render.setHorizontalAlignment(SwingConstants.CENTER);
            tableGhs.setDefaultRenderer(Object.class, render);
            tableGhs.setFont(new Font("微软雅黑", Font.PLAIN, 19));
        }
        scrollPane.setViewportView(tableGhs);

        JPanel panel_1 = new JPanel();
        panel.add(panel_1, BorderLayout.SOUTH);

        JButton btnGusSure = new JButton("确定");
        btnGusSure.setBackground(SystemColor.activeCaption);
        btnGusSure.setFocusPainted(false);
        btnGusSure.setFont(new Font("宋体", Font.PLAIN, 20));
        panel_1.add(btnGusSure);

        Component horizontalStrut = Box.createHorizontalStrut(100);
        panel_1.add(horizontalStrut);

        JButton btnGusExit = new JButton("退出");
        btnGusExit.setBackground(SystemColor.activeCaption);
        btnGusExit.setFocusPainted(false);
        btnGusExit.setFont(new Font("宋体", Font.PLAIN, 20));
        panel_1.add(btnGusExit);
    }
    ...
    public void showPanel(Component owner) {//触发的方法。参数是你要让那个组件作为你的父级窗口 触发悬浮
        if (pop != null)
            pop.hide();
        //下面的组件，就是你要触发显示的那个组件
        Point show = new Point(0, txtGHS.getHeight());//接受二个int参数让他显示在父级窗口哪个位置，
