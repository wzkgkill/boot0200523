...
public class FrmAddNewMain extends JFrame {
    ...
    public FrmAddNewMain() {
        ...
        //JComboBox comboBoxGuiGe = new JComboBox(guige);
...
//		//规格这个下拉列表，在选择发生改变的时候，要去填充“单位”下拉列表的值
        ...
        txtShangXian.addKeyListener(new KeyAdapter() {
            int keycode = 0;
        ...
        txtXiaXian.addKeyListener(new KeyAdapter() {
            int keycode = 0;
        ...
        txtJYmoney.addKeyListener(new KeyAdapter() {
            int keycode = 0;
        ...
        txtJSowmoney.addKeyListener(new KeyAdapter() {
            int keycode = 0;
        ...
        panel_14.setBorder(new EmptyBorder(10, 0, 5, 0));
        ...
        txtBZ.setMaximumSize(new Dimension(2147483647, 31));
        txtBZ.setPreferredSize(new Dimension(6, 21));
        ...
        panel_15.setBorder(new EmptyBorder(15, 0, 15, 0));
        ...
        String[] pro = {"湖南省", "湖北省", "江西省", "四川省", "广东省"};
        String[][] addre = {
                {"长沙市", "株洲市", "湘潭市", "衡阳市", "邵阳市"},
                {"武汉市", "黄石市", "荆门市", "孝感市", "十堰市"},
                {"九江市", "南昌市", "萍乡市", "赣州市", "上饶市"},
                {"自贡市", "德阳市", "成都市", "攀枝花市", "绵阳市"},
                {"深圳市", "广州市", "湛江市", "汕头市", "清远市"}
        };

        //JComboBox comProvince = new JComboBox();
        ...
        panel_15.add(comProvince);

        Component horizontalStrut_4 = Box.createHorizontalStrut(20);
        panel_15.add(horizontalStrut_4);
...
//						}
        ...
        btnSure.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if ("请选择规格".equals(comboBoxGuiGe.getSelectedItem())) {
                    JOptionPane.showMessageDialog(null, "请选择规格！");
                    return;
                }
                String sx1 = txtShangXian.getText().toString();//库存上限
                int sx3 = Integer.valueOf(sx1);//库存上限
                if ("".equals(txtJYmoney.getText())) {
                    JOptionPane.showMessageDialog(null, "请输入商品建议进价！");
                    return;
                }
                if ("".equals(txtJSowmoney.getText())) {
                    JOptionPane.showMessageDialog(null, "请输入商品建议售价！");
                    return;
                }
                int index = comProvince.getSelectedIndex();
                if (index == 0) {
                    JOptionPane.showMessageDialog(null, "请选择生产厂商！");
                    return;
                }
                //①获取商品名称，判断是否老商品中已经存在
                ...
                String dz = comProvince.getSelectedItem().toString() + comAddress.getSelectedItem().toString();//地址
...
//				paranA.ruk(re);
        ...
        panel_17.setLayout(new BorderLayout(10, 15));

        JPanel panel_18 = new JPanel();
        panel_18.setBorder(new EmptyBorder(10, 0, 0, 0));
        panel_17.add(panel_18, BorderLayout.NORTH);
        panel_18.setLayout(new GridLayout(0, 2, 10, 15));
