...
public class FrmEmpAddEmp extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FrmEmpAddEmp frame = new FrmEmpAddEmp();
    ...
    public FrmEmpAddEmp() {
        ...
        txtName.setBounds(124, 12, 181, 27);
        panel.add(txtName);
        ...
        txtTel.setBounds(124, 104, 181, 27);
        panel.add(txtTel);
        ...
        btnSure.setBounds(47, 337, 123, 29);
        panel.add(btnSure);
        ...
        btnEsc.setBounds(229, 337, 123, 29);
        panel.add(btnEsc);
        ...
        comboBox.setBounds(124, 54, 181, 27);
        panel.add(comboBox);
    }
